        ...
        <div className="about-me-content">
          ...
          <div className='image'>
            ...
            <p className="text">
              ...
              In my four years at OSU, I have been fortunate enough to complete four internships, at companies such as SpaceX, <a href='https://www.tesla.com/giga-texas'target='_blank'>Tesla</a>, and Marathon Petroleum! 
            </p>  
            <p className="text">
